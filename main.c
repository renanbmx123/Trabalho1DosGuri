...
#define NUM_TENTATIVAS_ATAQUE 5 // Numero de tentativas de acesso para considerar como erro
...
int runSNIFFER(char *ip_origem, char *ip_destino, char *interface, int porta)
{
